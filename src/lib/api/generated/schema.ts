...
export interface paths {
    ...
    "/ingredients": {
        ...
        /**
         * List ingredients
         * @description Get paginated list of ingredients with filters
         */
        get: {
            parameters: {
                query?: {
                    ...
                    category?: string;
                    /** @description Search in name, supplier */
                    search?: string;
